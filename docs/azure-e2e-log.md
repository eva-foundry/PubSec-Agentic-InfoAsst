...
- Image: `msubsandacr202603031449.azurecr.io/eva-api-gateway:phase-g`
- RG: `EVA-Sandbox-dev` (Canada Central) — reused existing chassis
- API: https://eva-agentic-api.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io
...
- Notes:
  - First deploy bypassed the Bicep `infra/main.bicep` template and was
    ...
    (AOAI `msub-eva-dev-openai`, Cosmos `msub-sandbox-cosmos-free`,
  ...
  - First boot seeded workspaces + bookings + model-registry + telemetry
    ...
    live Cosmos; `/v1/eva/archetypes` then returned all 5.
