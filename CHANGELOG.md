...
- Country-specific sample corpus under `data/sample-documents/` (EI Act, OAS Act, tribunal decision excerpts). Replaced with a README directing users to bring their own corpus.
