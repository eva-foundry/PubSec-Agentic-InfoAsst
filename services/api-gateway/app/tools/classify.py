...
_LEGISLATION_PATTERNS = [
    re.compile(r"\b(Act|Loi)\b.*\b(Parliament|Parlement|Congress|Statute|Code)\b", re.IGNORECASE),
    ...
    re.compile(r"\bStatutes\s+of\s+\w+\b", re.IGNORECASE),
...
_POLICY_PATTERNS = [
    ...
    re.compile(r"\b(Ministry|Department|Agency)\b", re.IGNORECASE),
    re.compile(
