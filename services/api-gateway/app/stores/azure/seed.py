...
async def _seed_workspaces(cosmos: CosmosClientManager) -> None:
    workspaces = [
        {
            "id": "ws-oas-act", "name": "OAS Act Legislation",
            ...
            "type": "legislation", "status": "active", "owner_id": "demo-carol",
            "data_classification": "protected_b", "document_capacity": 10, "document_count": 4,
            "monthly_cost": 4800.00, "cost_centre": "CC-OAS01", "infrastructure": _INFRASTRUCTURE,
            "business_prompt": _BUSINESS_PROMPTS["ws-oas-act"], "business_prompt_version": 1,
            "business_prompt_history": [{"version": 1, "content": _BUSINESS_PROMPTS["ws-oas-act"],
                                         "author": "system", "rationale": "Initial", "created_at": "2025-06-01T00:00:00Z"}],
            "created_at": "2025-06-01T00:00:00Z", "updated_at": "2026-04-01T00:00:00Z",
        },
        {
            "id": "ws-ei-juris", "name": "EI Jurisprudence",
            ...
            "type": "case_law", "status": "active", "owner_id": "demo-carol",
            "data_classification": "protected_b", "document_capacity": 15, "document_count": 6,
            "monthly_cost": 3200.00, "cost_centre": "CC-EIJ01", "infrastructure": _INFRASTRUCTURE,
            "business_prompt": _BUSINESS_PROMPTS["ws-ei-juris"], "business_prompt_version": 1,
            "business_prompt_history": [{"version": 1, "content": _BUSINESS_PROMPTS["ws-ei-juris"],
                                         "author": "system", "rationale": "Initial", "created_at": "2025-07-15T00:00:00Z"}],
            "created_at": "2025-07-15T00:00:00Z", "updated_at": "2026-03-20T00:00:00Z",
        },
        {
            "id": "ws-bdm-km", "name": "BDM Knowledge Management",
            ...
            "type": "knowledge_mgmt", "status": "active", "owner_id": "demo-carol",
            "data_classification": "protected_a", "document_capacity": 20, "document_count": 12,
            "monthly_cost": 2000.00, "cost_centre": "CC-BDM01", "infrastructure": _INFRASTRUCTURE,
            "business_prompt": _BUSINESS_PROMPTS["ws-bdm-km"], "business_prompt_version": 1,
            "business_prompt_history": [],
            "created_at": "2025-08-01T00:00:00Z", "updated_at": "2026-04-05T00:00:00Z",
        },
        {
            "id": "ws-faq", "name": "General FAQ",
            ...
            "type": "faq", "status": "active", "owner_id": "demo-carol",
            "data_classification": "unclassified", "document_capacity": 25, "document_count": 1,
            "monthly_cost": 1200.00, "cost_centre": "CC-FAQ01", "infrastructure": _INFRASTRUCTURE,
            "business_prompt": _BUSINESS_PROMPTS["ws-faq"], "business_prompt_version": 1,
            "business_prompt_history": [],
            "created_at": "2025-09-01T00:00:00Z", "updated_at": "2026-04-10T00:00:00Z",
        },
        {
            "id": "ws-sandbox", "name": "Sandbox / Training",
            ...
            "type": "sandbox", "status": "active", "owner_id": "demo-carol",
            "data_classification": "unclassified", "document_capacity": 50, "document_count": 3,
            "monthly_cost": 0.00, "cost_centre": "CC-SBX01", "infrastructure": _INFRASTRUCTURE,
            "business_prompt": _BUSINESS_PROMPTS["ws-sandbox"], "business_prompt_version": 1,
            "business_prompt_history": [],
...
async def _seed_bookings(cosmos: CosmosClientManager) -> None:
    bookings = [
        {"id": "bk-alice-oas", "workspace_id": "ws-oas-act", "requester_id": "demo-alice",
         "status": "active", "start_date": "2026-02-01", "end_date": "2026-06-30",
         "entry_survey_completed": True, "exit_survey_completed": False,
         "created_at": "2026-01-20T00:00:00Z", "updated_at": "2026-02-01T00:00:00Z"},
        {"id": "bk-alice-faq", "workspace_id": "ws-faq", "requester_id": "demo-alice",
         "status": "completed", "start_date": "2026-03-01", "end_date": "2026-03-31",
         "entry_survey_completed": True, "exit_survey_completed": True,
         "created_at": "2026-02-25T00:00:00Z", "updated_at": "2026-03-31T00:00:00Z"},
        {"id": "bk-eve-ei", "workspace_id": "ws-ei-juris", "requester_id": "demo-eve",
         "status": "active", "start_date": "2026-03-15", "end_date": "2026-07-31",
         "entry_survey_completed": True, "exit_survey_completed": False,
...
async def _seed_teams(cosmos: CosmosClientManager) -> None:
    teams = [
        {"id": "tm-alice-1", "booking_id": "bk-alice-oas", "workspace_id": "ws-oas-act",
         "user_id": "demo-alice", "email": "alice@demo.gc.ca", "name": "Alice Chen",
         "role": "admin", "added_at": "2026-02-01T00:00:00Z", "added_by": "demo-alice"},
        {"id": "tm-bob-1", "booking_id": "bk-alice-oas", "workspace_id": "ws-oas-act",
         "user_id": "demo-bob", "email": "bob@demo.gc.ca", "name": "Bob Wilson",
         "role": "reader", "added_at": "2026-02-01T00:00:00Z", "added_by": "demo-alice"},
        {"id": "tm-eve-1", "booking_id": "bk-alice-oas", "workspace_id": "ws-oas-act",
         "user_id": "demo-eve", "email": "eve@demo.gc.ca", "name": "Eve Tremblay",
         "role": "contributor", "added_at": "2026-02-05T00:00:00Z", "added_by": "demo-alice"},
        {"id": "tm-eve-2", "booking_id": "bk-eve-ei", "workspace_id": "ws-ei-juris",
         "user_id": "demo-eve", "email": "eve@demo.gc.ca", "name": "Eve Tremblay",
         "role": "admin", "added_at": "2026-03-15T00:00:00Z", "added_by": "demo-eve"},
        {"id": "tm-alice-2", "booking_id": "bk-eve-ei", "workspace_id": "ws-ei-juris",
         "user_id": "demo-alice", "email": "alice@demo.gc.ca", "name": "Alice Chen",
         "role": "reader", "added_at": "2026-03-16T00:00:00Z", "added_by": "demo-eve"},
    ]
    for t in teams:
...
async def _seed_surveys(cosmos: CosmosClientManager) -> None:
    entries = [
        {"id": "es-alice-oas", "booking_id": "bk-alice-oas",
         "use_case": "Legislative analysis of Old Age Security Act provisions",
         "expected_users": 8, "expected_data_volume_gb": 2.5,
    ...
    exits = [
        {"id": "xs-alice-faq", "booking_id": "bk-alice-faq",
         "satisfaction_rating": 4, "objectives_met": True, "data_disposition": "archive",
         "feedback": "Good experience overall. Would benefit from better bilingual support.",
         "would_recommend": True, "completed_at": "2026-03-31T16:00:00Z"},
    ]
    for x in exits:
...
async def _seed_clients(cosmos: CosmosClientManager) -> None:
    clients = [
        {"id": "client-bdm", "org_name": "Benefits Delivery Modernization",
         "entra_group_id": "grp-bdm-001", "billing_contact": "bdm-finance@esdc.gc.ca",
         "data_classification_level": "protected_b", "onboarded_at": "2026-01-15T00:00:00Z",
         "status": "active", "workspace_ids": ["ws-oas-act", "ws-ei-juris", "ws-bdm-km"]},
        {"id": "client-sco", "org_name": "Service Canada Operations",
         "entra_group_id": "grp-sco-001", "billing_contact": "sco-admin@servicecanada.gc.ca",
         "data_classification_level": "unclassified", "onboarded_at": "2026-03-01T00:00:00Z",
         "status": "active", "workspace_ids": ["ws-faq"]},
    ]
    for c in clients:
...
async def _seed_model_registry(cosmos: CosmosClientManager) -> None:
    models = [
        {"id": "chat-default", "model_name": "gpt-5-mini", "provider": "azure-openai",
         "deployment_name": "chat-default", "capabilities": ["chat", "function-calling", "streaming"],
         "classification_ceiling": "protected_b", "parameter_overrides": {"max_completion_tokens": 4096},
         "is_active": True, "access_grants": ["all"],
         "endpoint": "https://msub-eva-dev-openai.openai.azure.com/",
         "location": "canadaeast", "sku": "GlobalStandard", "capacity": 60,
         "model_version": "2025-08-07", "status": "deployed", "cost_model": "pay-as-you-go",
         "change_history": []},
        {"id": "reasoning-premium", "model_name": "gpt-5.1", "provider": "azure-openai",
         "deployment_name": "reasoning-premium",
         "capabilities": ["chat", "reasoning", "analysis", "function-calling", "streaming"],
         "classification_ceiling": "protected_b", "parameter_overrides": {"max_completion_tokens": 8192},
         "is_active": True, "access_grants": ["ws-oas-act", "ws-ei-juris"],
         "endpoint": "https://msub-eva-dev-openai.openai.azure.com/",
         "location": "canadaeast", "sku": "GlobalStandard", "capacity": 40,
         "model_version": "2025-11-13", "status": "deployed", "cost_model": "pay-as-you-go",
         "change_history": []},
        {"id": "embeddings-default", "model_name": "text-embedding-3-small", "provider": "azure-openai",
         "deployment_name": "embeddings-default", "capabilities": ["embeddings"],
         "classification_ceiling": "protected_b", "parameter_overrides": {},
         "is_active": True, "access_grants": ["all"],
         "endpoint": "https://msub-eva-dev-openai.openai.azure.com/",
         "location": "canadaeast", "sku": "Standard", "capacity": 80,
         "model_version": "1", "status": "deployed", "cost_model": "pay-as-you-go",
         "change_history": []},
    ]
    for m in models:
...
async def _seed_prompts(cosmos: CosmosClientManager) -> None:
    ...
    prompts = [
        {"id": str(uuid.uuid4()), "prompt_name": "rag-system", "version": 1, "is_active": True,
         ...
         "author": "system", "rationale": "Initial RAG system prompt", "created_at": now},
        {"id": str(uuid.uuid4()), "prompt_name": "ungrounded-system", "version": 1, "is_active": True,
         "content": (
             ...
             "- Respond in the same language as the user's question"),
         "author": "system", "rationale": "Initial ungrounded prompt", "created_at": now},
        {"id": str(uuid.uuid4()), "prompt_name": "query-rewrite", "version": 1, "is_active": True,
         "content": (
         ...
         "author": "system", "rationale": "Initial query rewrite prompt", "created_at": now},
    ]
    for p in prompts:
...
async def _seed_telemetry(cosmos: CosmosClientManager) -> None:
    ...
    for i in range(60):
        ...
        ts = base + timedelta(days=rng.randint(0, 13), hours=rng.randint(0, 9) + 8, minutes=rng.randint(0, 59))
        ...
        await cosmos.upsert("telemetry", {
            "id": str(uuid.UUID(int=rng.getrandbits(128))),
            "correlation_id": str(uuid.UUID(int=rng.getrandbits(128))),
            "timestamp": ts.isoformat(),
            "workspace_id": ws, "session_id": f"seed-session-{i // 5}",
            "client_id": client, "deployment": dep, "model_name": model_map.get(dep, dep),
            "operation": "chat/completions", "prompt_tokens": pt, "completion_tokens": ct,
            "total_tokens": pt + ct, "latency_ms": rng.randint(800, 3000),
            "cost_cad": cost, "status_code": 200 if rng.random() > 0.03 else 429,
        })
...
async def _seed_chat_history(cosmos: CosmosClientManager) -> None:
    ...
    records = [
        ...
        {"id": "msg-s1-1", "message_id": "msg-s1-1", "conversation_id": "conv-seed-1",
         "workspace_id": "ws-oas-act", "user_id": "demo-alice", "role": "user",
         "content_preview": "What are the eligibility requirements for Old Age Security?",
         "content_hash": sha("What are the eligibility requirements for Old Age Security?"),
         "citations": [], "provenance": None, "agent_steps": [],
         "confidence_score": 0.0, "model": "gpt-5.1-2026-04", "mode": "grounded",
         "created_at": "2026-04-10T09:00:00Z"},
        {"id": "msg-s1-2", "message_id": "msg-s1-2", "conversation_id": "conv-seed-1",
         "workspace_id": "ws-oas-act", "user_id": "demo-alice", "role": "assistant",
        ...
        # conv-seed-2: EI Juris, medium confidence
        {"id": "msg-s2-1", "message_id": "msg-s2-1", "conversation_id": "conv-seed-2",
         "workspace_id": "ws-ei-juris", "user_id": "demo-eve", "role": "user",
        ...
        {"id": "msg-s2-2", "message_id": "msg-s2-2", "conversation_id": "conv-seed-2",
         "workspace_id": "ws-ei-juris", "user_id": "demo-eve", "role": "assistant",
         ...
         "citations": [{"file": "ei-tribunal-decision-sample.txt", "page": 1, "section": "Analysis"}],
        ...
        {"id": "msg-s3-1", "message_id": "msg-s3-1", "conversation_id": "conv-seed-3",
         "workspace_id": "ws-oas-act", "user_id": "demo-bob", "role": "user",
        ...
        {"id": "msg-s3-2", "message_id": "msg-s3-2", "conversation_id": "conv-seed-3",
         "workspace_id": "ws-oas-act", "user_id": "demo-bob", "role": "assistant",
         ...
         "provenance": {"correlation_id": "corr-s3-1", "model": "gpt-5.1-2026-04",
                        "escalation_triggered": True, "escalation_reason": "Confidence below threshold (0.35 < 0.50)"},
         "agent_steps": [
        ...
        {"id": "msg-s4-1", "message_id": "msg-s4-1", "conversation_id": "conv-seed-4",
         "workspace_id": None, "user_id": "demo-alice", "role": "user",
        ...
        {"id": "msg-s4-2", "message_id": "msg-s4-2", "conversation_id": "conv-seed-4",
         "workspace_id": None, "user_id": "demo-alice", "role": "assistant",
