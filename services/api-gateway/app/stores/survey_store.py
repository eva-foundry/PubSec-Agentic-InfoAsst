    ...
    def _seed(self) -> None:
        ...
        entry_surveys = [
            EntrySurvey(
                ...
                use_case="Legislative analysis of social benefits Act provisions for adjudicators",
                expected_users=8,
            ...
            EntrySurvey(
                ...
                data_classification="sensitive",
                business_justification=(
                    "Appeals officers require citation-aware search across Benefits tribunal "
