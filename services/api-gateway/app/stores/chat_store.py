    ...
    def _seed(self) -> None:
        ...
        self._records.extend([
            ChatHistoryRecord(
                ...
                content_preview=_preview(
                    "What are the eligibility requirements for social benefits?"
                ),
                content_hash=_sha256("What are the eligibility requirements for social benefits?"),
                citations=[],
                provenance=None,
                agent_steps=[],
            ...
            ChatHistoryRecord(
                ...
                role="assistant",
                content_preview=_preview(
                    "Based on the social benefits Act, eligibility requires "
            ...
            ChatHistoryRecord(
                ...
                content_preview=_preview(
                    ...
                    "for each complete year of residence in the country after the age of 18 [1]. "
        ...
        self._records.extend([
            ...
            ChatHistoryRecord(
                ...
                role="user",
                content_preview=_preview(
                    "Can you check the regulations as well for international agreements?"
                ),
