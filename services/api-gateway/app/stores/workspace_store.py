...
# ---------------------------------------------------------------------------
# Shared Azure infrastructure config (sandbox real resources)
# ---------------------------------------------------------------------------
    ...
    def _seed(self) -> None:
        ...
        seed = [
            Workspace(
                ...
                description=(
                    "sensitive workspace for social benefits Act legislative analysis "
            ...
            Workspace(
                ...
                description=(
                    "sensitive workspace for labor tribunal decisions "
