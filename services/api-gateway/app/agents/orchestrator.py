...
- Expand acronyms when obvious (OAS → social benefits).
...
our Organization. Answer the user's question based ONLY on the \
...
_UNGROUNDED_SYSTEM = """\
You are AIA, a bilingual (EN/FR) assistant for Employment and Social \
our Organization. You are operating in ungrounded mode — no \
