...
export const useAdminClients = () => {
  ...
  return useQuery({
    ...
    queryFn: () => client.get<Client[]>("/v1/eva/admin/clients"),
  });
};
...
export const useCreateClient = () => {
  ...
  return useMutation({
    mutationFn: (body: Partial<Client>) => client.post<Client>("/v1/eva/admin/clients", body),
...
export const useClientInterviews = (clientId: string | null) => {
  ...
  return useQuery({
    ...
    queryFn: () => client.get<Interview[]>(`/v1/eva/admin/clients/${clientId}/interviews`),
    enabled: !!clientId,
  });
};
...
export const useAdminModels = () => {
  ...
  return useQuery({
    ...
    queryFn: () => client.get<ModelConfig[]>("/v1/eva/admin/models"),
  });
};
...
export const useModelHistory = (modelId: string | null) => {
  ...
  return useQuery({
    ...
    queryFn: () => client.get<Array<Record<string, unknown>>>(
      `/v1/eva/admin/models/${modelId}/history`,
    ),
    enabled: !!modelId,
  });
};
...
export const usePromptVersions = (name: string | null) => {
  ...
  return useQuery({
    ...
    queryFn: () => client.get<PromptVersion[]>(`/v1/eva/admin/prompts/${name}/versions`),
    enabled: !!name,
  });
};
