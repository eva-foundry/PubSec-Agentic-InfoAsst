...
export const CHAT_FIXTURE_EVENTS: ChatEvent[] = [
  ...
  { type: "content", delta: "social benefits ", conversation_id: CONV, message_id: MSG },
  ...
  },
  {
    ...
    explainability: {
      ...
      reasoning_summary: "Identified OAS monthly benefit from the the social benefits Act s.4 and cross-checked the 2023 regulations.",
...
export const WORKSPACES_FIXTURE = [
  {
    ...
    description: "social benefits Act corpus",
